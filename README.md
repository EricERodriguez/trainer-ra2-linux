This is a simple trainer for Command & Conquer Red Alert 2, running on an
UNIX or UNIX-like system. Distributed under the X11 license, see file
`COPYING` details.
...
* `we-are-watching-everywhere.sh` Reveal full map as long as you own any
structure.
